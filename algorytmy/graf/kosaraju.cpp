...
//użycie memoization, żeby nie liczyć wielokrotnie reachable nodes dla tego samego scc, sortowanie topologiczne
...
int main() {
    ...
    vector <vector<int>> SCCGraph(SCCs.size());  // nowe adjacency list dla SCCs
